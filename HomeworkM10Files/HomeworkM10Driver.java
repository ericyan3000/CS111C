...
public class HomeworkM10Driver {
	...
	public static void main(String[] args) {
		...
		numberStack.push(8);
	  	...
	  	System.out.println("Push 12:\n2 4 6 8 10 12 prioritized=false\n" + numberStack + "prioritized=" + prioritized + "\n");

	  	// push an element that is on the bottom of the stack
	  	prioritized = numberStack.priorityPush(2);
	  	System.out.println("Push 2:\n4 6 8 10 12 2 prioritized=true\n" + numberStack + "prioritized=" + prioritized + "\n");
	  	...
	  	System.out.println("Push 6:\n4 8 10 12 2 6 prioritized=true\n" + numberStack + "prioritized=" + prioritized + "\n");
	  	...
	  	System.out.println("Push 12:\n4 8 10 12 2 6 7 5 12 prioritized=true\n" + numberStack + "prioritized=" + prioritized + "\n");
     	...
     	System.out.println("Push dog:\ncat ant dog prioritized=true\n" + stringStack + "prioritized=" + prioritized + "\n");
    	...
    	peekStackLinked.push("my friend");
    	System.out.println("Should print \tand good night: " + peekStackLinked.peekNext());
    	System.out.println();
    	...
    	peekStackArray.push("my friend");
    	System.out.println("Should print \tand good night: " + peekStackArray.peekNext());
    	System.out.println();  
    }      
