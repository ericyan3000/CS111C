...
public class ListDequeTester {
		...
		public static void main(String[] args) {
			// *** to use, temporarily make the list in ArrayDeque public
			System.out.println("Create a deque: ");
			DequeInterface<String> myDeque = new ListDeque<String>();
			...
			System.out.println(wordDeque.list + "\tFront=" + wordDeque.getFront() + "\tBack=" + wordDeque.getBack());
